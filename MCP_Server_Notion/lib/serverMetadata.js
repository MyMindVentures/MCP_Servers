/**
 * Centralized server metadata for the Notion MCP server docs UI and /meta endpoint.
 */
...
const PLATFORM_NAME = "MCP Server — Notion";
const PLATFORM_DESCRIPTION =
  "Lightweight MCP server that exposes the official Notion API. Manage pages, databases, blocks, comments, and search from MCP-compatible clients.";
