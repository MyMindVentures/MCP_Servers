/**
 * Centralized server metadata for the ClickUp MCP server docs UI and /meta endpoint.
 */
import { getToolLabel, TOOL_GROUP_ORDER, TOOL_GROUP_LABELS } from './toolGroups.js';

const PLATFORM_NAME = 'MCP Server — ClickUp';
const PLATFORM_DESCRIPTION =
  'Lightweight MCP server that exposes the ClickUp API v2. Manage teams, spaces, folders, lists, tasks, goals, time tracking, views, custom fields, and webhooks from MCP-compatible clients.';
