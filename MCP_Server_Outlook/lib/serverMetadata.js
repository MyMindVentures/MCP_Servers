/**
 * Centralized server metadata for the Outlook MCP server.
 */
...
const PLATFORM_NAME = "MCP Server — Outlook";
const PLATFORM_DESCRIPTION =
  "Lightweight MCP server that exposes Microsoft Graph (Outlook) API for mail, calendar, and contacts. Use with MCP-compatible clients.";
